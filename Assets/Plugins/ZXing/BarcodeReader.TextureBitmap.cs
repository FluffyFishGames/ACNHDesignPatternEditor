...
namespace ZXing
{
    ...
    /// </summary>
    public class BarcodeReader : BarcodeReader<TextureBitmap>, IBarcodeReader
    {
        private static readonly Func<TextureBitmap, LuminanceSource> defaultCreateLuminanceSource =
           (bitmap) => new TextureBitmapLuminanceSource(bitmap);
        ...
        public BarcodeReader(Reader reader,
           Func<TextureBitmap, LuminanceSource> createLuminanceSource,
