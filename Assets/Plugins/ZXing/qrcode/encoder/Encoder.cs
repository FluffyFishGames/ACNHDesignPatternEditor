...
namespace ZXing.QrCode.Internal
{
    ...
    {
        public static bool ForceByte = false;
                                  ...
                                  IDictionary<EncodeHintType, object> hints)
        {
         ...
         var generateECI = hasEncodingHint;
            ...
            if (hints != null && hints.ContainsKey(EncodeHintType.STRUCTURED_APPEND))
            {
                int[] vals = (int[]) hints[EncodeHintType.STRUCTURED_APPEND];
                headerBits.appendBits(3, 4);
                headerBits.appendBits(vals[0], 4);
                headerBits.appendBits(vals[1], 4);
                headerBits.appendBits(vals[2], 8);
                UnityEngine.Debug.Log("STRUCTURED APPEND " + vals[0] + ";" + vals[1] + ";" + vals[2]);
            }
